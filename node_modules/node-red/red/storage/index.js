...
var storageModuleInterface = {
        ...
        deleteFlows: function(){
            if(storageModule.deleteFlows){
                return storageModule.deleteFlows();
            }else{
                return when.resolve();
            }
        },
        ...
        getAllStates: function(){
            if(storageModule.getAllStates){
                return storageModule.getAllStates();
            }else {
                return when.resolve();
            }
        },
        getState: function(item_id){
            if(storageModule.getState){
                return storageModule.getState(item_id);
            }else {
                return when.resolve();
            }
        },
        saveState: function(item_id, state){
            if(storageModule.saveState){
                return storageModule.saveState(item_id, state);
            }else {
                return when.resolve();
            }
        },
